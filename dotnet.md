...
<!-- news_marker starts -->
- Emit logs on-demand with log buffering ([just now](https://devblogs.microsoft.com/dotnet/emit-logs-on-demand-with-log-buffering/))
- API Caching Done Right ([37 minutes ago](https://dotnetkicks.com/r/722126?url=https://codeopinion.com/api-caching-done-right/))
...
- Catch Up on Microsoft Build 2025: Essential Sessions for .NET Developers - .NET Blog ([21 hours ago](https://dotnetkicks.com/r/722051?url=https://devblogs.microsoft.com/dotnet/catching-up-on-microsoft-build-2025-essential-sessions-for-dotnet-developers/))
