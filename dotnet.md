...
<!-- news_marker starts -->
- Web Category Filtering ([14 minutes ago](https://dotnetkicks.com/r/721397?url=https://textslashplain.com/2025/05/27/web-category-filtering/))
...
- Circuit Breaker Policy Fine-tuning Best Practice ([10 hours ago](https://devblogs.microsoft.com/dotnet/circuit-breaker-policy-finetuning-best-practice/))
...
- Converting a docker-compose file to .NET Aspire ([18 hours ago](https://andrewlock.net/converting-a-docker-compose-file-to-aspire/))
