...
<!-- news_marker starts -->
- EFCore.Visualizer – View Entity Framework Core query plan inside Visual Studio ([1 minutes ago](https://devblogs.microsoft.com/dotnet/ef-core-visualizer-view-entity-framework-core-query-plan-inside-visual-studio/))
