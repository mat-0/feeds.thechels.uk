...
- GPT-OSS – A C# Guide with Ollama ([13 hours ago](https://devblogs.microsoft.com/dotnet/gpt-oss-csharp-ollama/))
...
- Converting an xUnit test project to TUnit ([20 hours ago](https://andrewlock.net/converting-an-xunit-project-to-tunit/))
