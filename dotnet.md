...
<!-- news_marker starts -->
- Use EdDSA signatures to validate tokens in ASP.NET Core using OpenID Connect ([8 hours ago](https://dotnetkicks.com/r/726972?url=https://damienbod.com/2025/08/06/use-eddsa-signatures-to-validate-tokens-in-asp-net-core-using-openid-connect/))
