...
- Exploring the features of dotnet run app.cs: Exploring the .NET 10 preview - Part 1 ([9 hours ago](https://andrewlock.net/exploring-dotnet-10-preview-features-1-exploring-the-dotnet-run-app.cs/))
