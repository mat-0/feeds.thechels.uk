...
<!-- news_marker starts -->
- Prompt Files and Instructions Files Explained ([1 minutes ago](https://devblogs.microsoft.com/dotnet/prompt-files-and-instructions-files-explained/))
...
- .NET STS releases supported for 24 months - .NET Blog ([23 hours ago](https://dotnetkicks.com/r/729969?url=https://devblogs.microsoft.com/dotnet/dotnet-sts-releases-supported-for-24-months/))
