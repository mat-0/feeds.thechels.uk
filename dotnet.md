...
<!-- news_marker starts -->
- Boost Your .NET Projects: Mastering Unit Testing with Spargine’s UnitTester Class ([6 hours ago](https://dotnettips.wordpress.com/2025/06/04/boost-your-net-projects-mastering-unit-testing-with-spargines-unittester-class/))
...
- Using AI Foundry with .NET MAUI ([19 hours ago](https://devblogs.microsoft.com/dotnet/using-ai-foundry-with-dotnet-maui/))
