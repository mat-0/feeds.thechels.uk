...
<!-- news_marker starts -->
- Live Stream Previewing Wolverine 5.0 on Thursday ([6 hours ago](https://dotnetkicks.com/r/728887?url=https://jeremydmiller.com/2025/09/03/live-stream-previewing-wolverine-5-0-on-thursday/))
- Let Copilot Coding Agent handle the busy work - .NET Blog ([15 hours ago](https://dotnetkicks.com/r/728879?url=https://devblogs.microsoft.com/dotnet/copilot-coding-agent-dotnet/))
- Let Copilot Coding Agent handle the busy work ([15 hours ago](https://devblogs.microsoft.com/dotnet/copilot-coding-agent-dotnet/))
