...
<!-- news_marker starts -->
- Coding Faster with dotNetTips Spargine: Validating Arguments Made Easy with Validator ([7 hours ago](https://dotnettips.wordpress.com/2025/05/25/coding-faster-with-dotnettips-spargine-validating-arguments-made-easy-with-validator/))
- F# Weekly #21, 2025 - Build 2025 &amp; ReSharper in VS Code ([18 hours ago](https://dotnetkicks.com/r/721063?url=https://sergeytihon.com/2025/05/24/f-weekly-21-2025-build-2025-resharper-in-vs-code/))
...
- Azure AI Foundry: What is it and Why Should You Care ([2 days ago](https://dotnetkicks.com/r/720812?url=https://www.mobilize.net/blog/azure-ai-foundry-what-is-it-and-why-should-you-care?utm_source=DNK-720812&utm_medium=DNK-720812&utm_content=DNK-720812&utm_campaign=DNK-720812))
...
- Message Concurrency, Parallelism, and Ordering with Wolverine ([3 days ago](https://dotnetkicks.com/r/720795?url=https://jeremydmiller.com/2025/05/21/message-concurrency-parallelism-and-ordering-with-wolverine/))
- AI and Vector Data Extensions are now Generally Available (GA) - .NET Blog ([3 days ago](https://dotnetkicks.com/r/720759?url=https://devblogs.microsoft.com/dotnet/ai-vector-data-dotnet-extensions-ga/))
- AI and Vector Data Extensions are now Generally Available (GA) ([3 days ago](https://devblogs.microsoft.com/dotnet/ai-vector-data-dotnet-extensions-ga/))
- Connecting to Private NuGet Feeds Just Got Easier - Visual Studio Blog ([3 days ago](https://dotnetkicks.com/r/720743?url=https://devblogs.microsoft.com/visualstudio/connecting-to-private-nuget-feeds-just-got-easier/))
- AI Shell Preview 4 Release! - PowerShell Team ([3 days ago](https://dotnetkicks.com/r/720721?url=https://devblogs.microsoft.com/powershell/preview-4-ai-shell/))
- Announcing Public Preview of DiskANN in SQL Server 2025  -  Microsoft Community Hub ([3 days ago](https://dotnetkicks.com/r/720709?url=https://techcommunity.microsoft.com/blog/sqlserver/announcing-public-preview-of-diskann-in-sql-server-2025/4414683))
...
- .NET Aspire 9.3 is here and enhanced with GitHub Copilot! ([5 days ago](https://devblogs.microsoft.com/dotnet/introducing-dotnet-aspire-93/))
- Faster .NET Upgrades Powered by GitHub Copilot - Visual Studio Blog ([5 days ago](https://dotnetkicks.com/r/720443?url=https://devblogs.microsoft.com/visualstudio/faster-net-upgrades-powered-by-github-copilot/))
- Accelerate Your .NET Upgrades with GitHub Copilot - .NET Blog ([5 days ago](https://dotnetkicks.com/r/720428?url=https://devblogs.microsoft.com/dotnet/github-copilot-upgrade-dotnet/))
- Accelerate Your .NET Upgrades with GitHub Copilot ([5 days ago](https://devblogs.microsoft.com/dotnet/github-copilot-upgrade-dotnet/))
...
- How to Watch Microsoft Build 2025 Online - Visual Studio Blog ([8 days ago](https://dotnetkicks.com/r/720228?url=https://devblogs.microsoft.com/visualstudio/how-to-watch-microsoft-build-2025-online/))
...
- Evaluating content safety in your .NET AI applications - .NET Blog ([9 days ago](https://dotnetkicks.com/r/720127?url=https://devblogs.microsoft.com/dotnet/evaluating-ai-content-safety/))
- Evaluating content safety in your .NET AI applications - .NET Blog ([9 days ago](https://dotnetkicks.com/r/720117?url=https://devblogs.microsoft.com/dotnet/evaluating-ai-content-safety/))
- Evaluating content safety in your .NET AI applications ([9 days ago](https://devblogs.microsoft.com/dotnet/evaluating-ai-content-safety/))
...
- ReSharper and Rider 2025.1.2 – Bug Fixes Have Landed! ([16 days ago](https://blog.jetbrains.com/dotnet/2025/05/08/resharper-rider-2025-1-2-bug-fix/))
- Why we built our startup in C# ([17 days ago](https://devblogs.microsoft.com/dotnet/why-we-built-our-startup-in-csharp/))
...
- Packaging and Publishing a .NET MAUI Library with GitHub Actions ([24 days ago](https://devblogs.microsoft.com/dotnet/dotnet-maui-libraries-github-actions/))
