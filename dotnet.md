...
- sleep-pc: a .NET Native AOT tool to make Windows sleep after a timeout ([9 hours ago](https://andrewlock.net/sleep-pc-a-dotnet-tool-to-make-windows-sleep-after-a-timeout/))
